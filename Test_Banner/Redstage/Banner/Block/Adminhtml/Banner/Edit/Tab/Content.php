 ...
 */
namespace Redstage\Banner\Block\Adminhtml\Banner\Edit\Tab;

/**
 * Class Content
 * @package Redstage\Banner\Block\Adminhtml\Banner\Edit\Tab
 */
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('current_rsbanner');
    ...
    {
        return $this->_coreRegistry->registry('current_rsbanner')
            ->getStoreContents();
    }
    ...
    {
        $storeContents = $this->_coreRegistry->registry('current_rsbanner')->getStoreContents();
